...
- **核心劑量反應複現（有效劑量段 −8…+4）。** mean_bet 4.02 → 4.89 → 5.14 → 5.13 → 5.60 → 6.28 → **7.06**，Spearman ρ=**0.464**（n=4,496, p=1.4e−238）；bet10% 由 11.9% 升至 41.2%。與 Llama 同形。**核心解離主張只建立在這一段上**；+6/+8 另列為 intervention overload（見下），不參與劑量趨勢。
