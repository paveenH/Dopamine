...
|---|---|---:|---:|---:|---:|:--|---|
| **pre-commit** (n=281) | `abs_mean` | 0.763 | 0.818 | **+0.056** | 0.42 | *** | CoT 推理段 fast 幅度更大 |
| | `std` | 0.928 | 1.019 | **+0.092** | **0.63** | *** | CoT 瞬時波動明顯更強 |
| | `pos_peak` | 2.108 | 2.350 | +0.242 | 0.41 | *** | 正向尖峰更高 |
| | `neg_peak` | −2.583 | −3.311 | **−0.728** | **−0.82** | *** | **負向尖峰深得多（全節最大效應，且不對稱偏負）** |
