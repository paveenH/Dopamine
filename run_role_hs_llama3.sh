...
# ================= Role Hidden-State Extraction: Llama3 =================
...
#   CUDA_VISIBLE_DEVICES=0 nohup bash run_role_hs_llama3.sh > role_hs_llama3.log 2>&1 &
#
# Syntax check only (no GPU/model needed): bash -n run_role_hs_llama3.sh
