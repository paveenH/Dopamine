...
# Full official test split, 3 configs (main/p1/p2) x 4-point alpha sweep, one
# model, ONE GPU, sequential -- so the whole per-model curve is byte-comparable
# (bf16 greedy is not reproducible across GPUs/cards).
#
