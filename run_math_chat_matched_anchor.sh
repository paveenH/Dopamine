...
# PRIMARY task -- run this FIRST. INDEPENDENT of the frozen bare-string MATH
...
#
# Four alpha only (-6, 0, +6, +8), NOT the nine-point sweep -- a targeted
# family: 0 = this family's own baseline, -6 = the frozen bare MATH
# workpoint, +6/+8 = the region where the native chat sweep showed
# early-candidate-rate / generation-compression onset. All four run in ONE
# invocation, ONE model load.
#
...
# Fixed, frozen FOUR-point dose set -- NOT the nine-point family.
...
echo ""
echo "Once MATH results are reviewed and confirmed, phase 2 (GSM8K) is:"
echo "  CUDA_VISIBLE_DEVICES=<n> CONFIRMED=1 bash run_gsm8k_chat_matched_anchor.sh"
echo "=================================================="
